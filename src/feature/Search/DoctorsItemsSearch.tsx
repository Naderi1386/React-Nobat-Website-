...
const DoctorsItemsSearch = ({ doctor }: DoctorsItemPropType) => {
  ...
  return (
    <li
      ...
      className="px-4 pt-4 pb-6  cursor-pointer md:rounded-[4px]  space-y-4 w-full  custome1355:w-[49%] h-[177.6px]    border-b md:border border-solid border-stone-500/15"
    >
...
export default DoctorsItemsSearch;
